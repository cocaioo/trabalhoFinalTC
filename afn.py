"""
afn.py - Módulo de definição do AFN-ε
...
class Estado:
    ...
    def __init__(self):
        ...
        Estado.contador += 1
        self.transicoes = {}  # {símbolo: [estados_destino]}
        self.eh_final = False
    
    def adicionar_transicao(self, simbolo, estado_destino):
        """Adiciona uma transição para este estado"""
...
class AFN:
    """Representa um Autômato Finito Não Determinístico com epsilon-transições"""
    ...
    def obter_todos_estados(self):
        """Retorna todos os estados alcançáveis do autômato"""
        visitados = set()
    ...
    def obter_transicoes(self):
        """Retorna todas as transições do autômato"""
        transicoes = []
    ...
    def exibir_texto(self):
        """Exibe a estrutura do AFN-ε em formato texto"""
        estados = self.obter_todos_estados()
