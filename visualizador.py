...
class VisualizadorAFN:
    ...
    def visualizar(self, titulo="AFN-ε"):
        ...
        for estado, (x, y) in self.posicoes.items():
            ...
            # Estado final tem círculo duplo
            if estado.eh_final:
        ...
        # Seta de entrada para estado inicial
        ...
        ax.text(0.5, 6.1, '● Verde: Estado Inicial  ● Azul: Estados  ◎ Círculo Duplo: Estado Final',
               fontsize=10, ha='left')
